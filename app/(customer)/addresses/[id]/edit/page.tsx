    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 ml-11">Update your delivery address information</p>
        </div>
        ...
        {success && (
          <div className="mb-6 bg-green-50 border-2 border-green-200 rounded-xl p-4 animate-fadeInUp">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-base font-semibold text-green-900">Address updated successfully!</p>
                <p className="text-sm text-green-700">Redirecting to addresses...</p>
              </div>
            </div>
          </div>
        )}
